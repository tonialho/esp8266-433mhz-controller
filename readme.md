...
Files:
- _esp8266_433mhz_controller.ino_ | the source code
- _index.html | a separate html_ file for easier editing of the UI code (located in the source code)
...
- Additional heater control
	- Student apartments are not known for excessive nor controllable heating, an extra relay controlled radiator would allow me to adjust room temperature a bit via UI or automation (for example, one extra degree celcius in mornings)
